...
$(function () {
    ...
    var definedHomepage = !!localStorage['homepage'];
    console.log(definedHomepage)
    ...
    $('#auto-open-homepage').click(function(){
        if($(this).is(':checked')){
            ...
            $('#choose-homepage').show();
            //没有主页, 默认设置一个,防止用户关闭页面出错
            if(!localStorage['homepage']){
                localStorage['homepage'] = 'chrome://newtab';
            }
        }else{
